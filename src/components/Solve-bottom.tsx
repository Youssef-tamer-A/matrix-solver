...
export default function SolveBottom() {
  const { solve, solved, resetSolution, useFractions, setUseFractions } =
    useGridStore();
    ...
    <div className="mt-10 mb-10 text-right" dir="rtl">
      {!solved ? (
        <div className="space-y-4">
          {/* Checkbox للكسور */}
          <label className="flex items-center gap-3 cursor-pointer bg-white rounded-xl p-4 shadow-md border border-gray-200 hover:border-blue-300 transition-all duration-200">
            <div className="relative">
              ...
              />
              <div className="w-6 h-6 border-2 border-gray-300 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-all duration-200 flex items-center justify-center">
                {useFractions && (
                  <svg
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500">(بسط / مقام)</span>
              <div
